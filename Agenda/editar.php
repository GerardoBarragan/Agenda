...
?>
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Gruposid:</td>
      <td><input type="text" name="gruposid" value="<?php echo htmlentities($row_seleccontacto['gruposid'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">&nbsp;</td>
      <td> <td><input class="btn btn-small btn-primary" type="submit" value="Editar"</td></td>
    </tr>
  </table>
...
$vcontacto_seleccontacto = "0";
if (isset($_GET['contacto_id'])) {
  $vcontacto_seleccontacto = $_GET['contacto_id'];
}
mysql_select_db($database_Agendadb, $Agendadb);
$query_seleccontacto = sprintf("SELECT * FROM contacto, grupos WHERE contacto.Idcontacto=%s and grupos.idgrupo=contacto.gruposid", GetSQLValueString($vcontacto_seleccontacto, "int"));
